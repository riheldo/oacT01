...
de_azul:		.asciiz " de componente B\n" 
de_verde:		.asciiz " de componente G\n"
de_vermelho:		.asciiz " de componente R\n" 
...
get_point: 
	...
	srl $a0, $t5, 24		#desloca o resultado para a posicao correta - a0 fica somente com o componente azul
	...
	srl $a0, $t6, 24		#desloca o numero de cor composta para apagar a componente vermelho - ao fica somente verde
	li $v0, 1			#printa o numero do componente verde
	syscall				
	la, $a0, de_verde		#printa a informacao que e verde
	li $v0, 4	
	syscall
	srl $a0, $t7, 16		#desloca o numero composto, restando somente componente vermelho em a0
